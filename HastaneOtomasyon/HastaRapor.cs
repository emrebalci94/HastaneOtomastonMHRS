...
namespace HastaneOtomasyon
{
    public partial class HastaRapor : Form
    {
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                dataGridView1.DataSource = ListelemeIslemleri.HastaRaporAl(textBox1.Text);
            }
            else if (comboBox1.SelectedIndex == 1)
            {
                dataGridView1.DataSource = ListelemeIslemleri.HastaRaporAlTc(textBox1.Text);
            }
        }
        Bitmap veriler;
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("HASTA BİLGİSİ RAPORLARI", kocabaslik, Brushes.Black, 250, 50);
